...
- HyperFrames CLI repository package version: `0.7.60`; Node.js requirement: `>=22`.
...
Licenses and cloud APIs can change. Recheck them before paid production or architectural migration.
